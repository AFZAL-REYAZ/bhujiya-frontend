  ...
  return (
    <div className="font-sans pt-5">
      ...
      <section className="relative min-h-[700px] py-1 lg:py-1 flex items-center 
          bg-gradient-to-br from-red-950 via-red-800 to-red-900 text-white overflow-hidden">
    ...
    bg-[url('https://www.transparenttextures.com/patterns/p6.png')]" />
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 xl:px-24
                  grid md:grid-cols-2 items-center gap-14 xl:gap-20
                  z-10 relative">
          ...
          >
            <motion.h2
              ...
              className="text-xl md:text-2xl font-script text-yellow-400 
                   mb-4 italic tracking-wide"
            >
              Tasty • Crunchy • Authentic
            </motion.h2>
            ...
            >
              ...
              <br />
              <span className="bg-gradient-to-r from-yellow-300 via-orange-400 to-yellow-200 
            ...
            <motion.p
              ...
              className="text-red-100 mb-10 max-w-lg text-lg leading-relaxed 
                   border-l-4 border-yellow-400/50 pl-6"
            >
              Discover the authentic taste of tradition with our premium,
              dry-fruit loaded plum cakes and carefully crafted signature snacks.
            </motion.p>
            ...
            >
              <motion.button
                whileHover={{ scale: 1.05, boxShadow: "0px 0px 25px rgba(251,191,36,0.35)" }}
                whileTap={{ scale: 0.95 }}
                className="bg-white text-red-900 px-10 py-4 rounded-full 
                     font-black text-lg uppercase tracking-wider 
                     shadow-2xl hover:bg-yellow-50 transition"
              >
                Shop Now
              </motion.button>
              ...
              <motion.button
                ...
                className="border-2 border-white/30 backdrop-blur-sm 
                     px-8 py-4 rounded-full font-bold text-lg transition"
              >
                Explore Collection
              </motion.button>
            </motion.div>
          ...
          >
            <div className="absolute inset-0 bg-yellow-400/20 rounded-full 
                      blur-[100px] scale-75 
                      group-hover:bg-yellow-400/30 transition duration-700" />
            ...
            >
              ...
              <motion.div
                ...
                className="absolute -top-8 -right-8 bg-yellow-400 text-red-900 
                     h-28 w-28 rounded-full flex flex-col 
                     items-center justify-center font-black 
                     shadow-2xl border-4 border-white rotate-12 z-20"
              >
                <span className="text-xs tracking-wide">SALE</span>
...
{/* ================= Plum Cake Collection (Premium) ================= */}
<section className="py-8 bg-gradient-to-b from-red-50/60 via-white to-white overflow-hidden">
  <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 xl:px-24">
    ...
    >
      {/* <span className="inline-block text-red-700 font-semibold uppercase tracking-[0.35em] text-xs mb-4">
        Premium Selection
      </span> */}

      <h2 className="text-xl md:text-2xl xl:text-3xl font-extrabold text-red-950">
        Our Best Sellers
      </h2>

      <p className="max-w-xl mx-auto mt-4 text-gray-600 text-lg">
        Crafted with tradition, packed with premium dry fruits,
        and loved by thousands of customers.
      </p>

      <div className="h-1 w-24 bg-gradient-to-r from-red-700 to-red-400 mx-auto mt-6 rounded-full" />
    </motion.div>
  ...
  className="group relative bg-white rounded-[2.2rem]
             ...
             hover:shadow-[0_25px_55px_rgba(220,38,38,0.18)]
             transition-all duration-500"
>
  {/* ===== Image ===== */}
  <div className="relative overflow-hidden rounded-t-[2.2rem] aspect-square">
    <motion.img
    ...
    <div className="absolute inset-0 bg-gradient-to-t 
                    from-red-950/25 to-transparent 
                    opacity-0 group-hover:opacity-100 
                    transition-opacity duration-500" />

    {cake.tag && (
      <div className="absolute top-4 left-4 bg-white/90 
                      text-red-700 text-[10px] font-bold 
                      px-3 py-1 rounded-full uppercase 
                      tracking-widest shadow">
        {cake.tag}
      </div>
    )}
  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center gap-16">
          ...
          >
            <motion.div variants={{ hidden: { x: 20, opacity: 0 }, show: { x: 0, opacity: 1 } }}>
              ...
              <h2 className="text-2xl md:text-3xl font-black text-green-950 mb-6 leading-tight">
                Ultra Thin <br />
            ...
            >
              {['100g', '200g', '500g'].map((weight, i) => (
                <motion.button
                  ...
                  whileHover={{ y: -3 }}
                  whileTap={{ scale: 0.95 }}
                  className={`px-6 py-2 rounded-xl font-bold transition-all border-2 ${i === 0
