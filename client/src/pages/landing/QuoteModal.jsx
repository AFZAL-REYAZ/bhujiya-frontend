  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center px-2">
      <div className="w-full max-w-xl bg-white rounded-xl shadow-2xl overflow-hidden">
        <div className="flex">
          <div className="hidden md:block w-1/3 bg-gray-50 p-2">
          ...
          <div className="flex-1 p-4">
            <div className="flex items-start justify-between mb-1">
              <h3 className="text-base font-bold text-gray-900">Get Best Quote and quick callback</h3>
              <button onClick={onClose} className="text-gray-500 hover:text-gray-900 text-lg leading-none">
                ×
              </button>
            </div>
            <form
            ...
            >
              <div className="grid sm:grid-cols-2 gap-2">
                <div>
                  ...
                  <input
                    ...
                    className="mt-0.5 w-full rounded-lg border border-gray-200 px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-600/30"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="mt-0.5 w-full rounded-lg border border-gray-200 px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-600/30 resize-none"
                  placeholder="Share any specific requirements"
                />
              </div>
              <button
                type="submit"
                className="mt-1 w-full inline-flex items-center justify-center rounded-lg bg-[#0b3b2a] text-white text-sm font-bold px-4 py-2"
              >
                Submit Now
              </button>
